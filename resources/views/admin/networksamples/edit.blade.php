        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route('networksamples.update', $networkSample->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            ...
                            <textarea name="description" id="description" cols="30" rows="10" class="form-control col-md-7"> {{ $networkSample->description }} </textarea>
                        </div>
                        <div class="form-group row">
                    ...
                    <form action="{{ route('networksamples.destroy', $networkSample->id) }}" method="POST">
